...
class HeaderMedia extends StatefulWidget {
  const HeaderMedia({Key? key}) : super(key: key);

  @override
  _HeaderMediaState createState() => _HeaderMediaState();
}

class _HeaderMediaState extends State<HeaderMedia> {
  ...
  Future<void> _loadMediaFromFirestore() async {
    try {
      ...
      if (doc.exists && doc.data() != null) {
        ...
        _fallbackImageUrl = data['boarding_homepage_fallback'] as String?;

        // Continue with the primary media URL.
        if (data.containsKey('boarding_homepage')) {
          final url = data['boarding_homepage'] as String?;
