      ...
      if (_reportType.isEmpty) {
        ...
        final proceed = await showDialog<bool>(
          ...
          builder: (_) => AlertDialog(
            title: const Text('No Vaccination Info'),
            content: const Text(
                'Since you did not add a vaccination report, it will be marked as “never vaccinated”. Continue?'),
            actions: [
...
// ✨ NEW FIX: Use Uint8List directly
    void _onCropped(Uint8List data) {
      _doCrop(data); // Pass the raw data directly to the file saving function
    }
