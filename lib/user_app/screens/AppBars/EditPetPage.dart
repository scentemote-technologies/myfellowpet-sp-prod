      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            // In the FreeFormCropSheet class (around line 68 in the file you provided)
            Expanded(
              child: Crop(
                controller: _controller,
                image: widget.file.readAsBytesSync(),
                // 🛑 FIX HERE: Change the implementation to match 0.7.3 API
                onCropped: (Uint8List data) { // 👈 The data is the Uint8List directly
                  // Instead of checking for CropSuccess, just pass the data!
                  widget.onCropped(data);
                  // Only navigate when cropping is complete
