          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Vaccination Info', style: GoogleFonts.poppins(
                  fontSize: 16, fontWeight: FontWeight.w600, color: accent,
                )),
                const SizedBox(height: 8),
                ElevatedButton.icon(
                  onPressed: !_canEdit ? null : _showVaccineDialog,
                ...
                if (_reportType == 'manually_entered' && _vaccines.isNotEmpty)
                  Padding(
                    padding: const EdgeInsets.only(top: 8.0),
                    child: Text(
                      _vaccines.map((v) => v['name']).join(', '),
