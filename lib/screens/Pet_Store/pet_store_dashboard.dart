...
class PetStoreDetailsPage extends StatelessWidget {
  ...
  final String specialtyNiche;
  final String partnerPolicyUrl; // <-- ADD THIS LINE
  final List<String> productCategories;
  final List<String> petTypesCatered;
  ...
  // Store Hours (nested map)
  final Map<String, Map<String, String>> storeHours;

  // Logistics (all stored as String for safety)
  final String deliveryRadiusKm;
  final String fulfillmentTimeMin;
  final String minOrderValue;
  final String flatDeliveryFee;
  // Policies & Returns
  final String supportEmail;
  final String returnPolicyText;
  final String returnWindowValue;
  final String returnWindowUnit;
  final String idUrl;
  final String utilityBillUrl;
  final String idWithSelfieUrl;

  const PetStoreDetailsPage({
    Key? key,
    required this.serviceId,
    required this.specialtyNiche,
    required this.notificationEmail,
    required this.description,
    required this.productCategories,
    required this.petTypesCatered,
    ...
    required this.ownerName, required this.partnerPolicyUrl,
  }) : super(key: key);
...
class PetStoreDashboard extends StatefulWidget {
  ...
  @override
  State<PetStoreDashboard> createState() =>
      _PetStoreDashboardState();
}

// V V V REPLACE THE ENTIRE '_BoardingDetailsDashboardState' CLASS V V V

class _PetStoreDashboardState extends State<PetStoreDashboard> {
