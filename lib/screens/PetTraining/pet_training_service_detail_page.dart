...
class PetTrainingServiceDetailsPage extends StatelessWidget {
  ...
  const   PetTrainingServiceDetailsPage({
    Key? key,
...
class PetWalkingServiceDashboard extends StatefulWidget {
  ...
  const PetWalkingServiceDashboard({
    Key? key,
    required this.shopName,
    required this.adminApproved,
    required this.imageUrls,
  ...
  @override
  State<PetWalkingServiceDashboard> createState() =>
      _PetWalkingServiceDashboardState();
}

// V V V REPLACE THE ENTIRE '_BoardingDetailsDashboardState' CLASS V V V

class _PetWalkingServiceDashboardState extends State<PetWalkingServiceDashboard> {
