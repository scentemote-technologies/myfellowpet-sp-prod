...
const Color walkingColor = Color(0xFF319736); // Teal for boarding
const Color trainingColor = Color(0xFF753197); // Teal for boarding
...
class _ProfileSelectionScreenState extends State<ProfileSelectionScreen> {
  ...
  Widget _buildProfileCard(BuildContext context, AppUser profile) {
    ...
    } else if (profile.serviceType.contains('Training')) {
      icon = Icons.directions_walk;
      iconColor = trainingColor;
      typeSuffix = '(Training)';
    } else {
      // Assumes 'Boarding' or 'Home Run'
      ...
      child: InkWell(
        onTap: () {
          ...
          if (mounted) {
            ...
            else if (profile.serviceType.contains('Pet Training')) {
              // Pet Training
              context.go('/partner/pet-training/${profile.serviceId}/profile');
              print("💛 Navigated to Pet Training Profile: /partner/pet-training/${profile.serviceId}/profile");
            } else {
              // Default / Boarding
